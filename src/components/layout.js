...
const collections = [
  ...
  {
    page: "collection_roz",
    name: "layout.fw_roz_name",
    to: "/collection/fw-roz",
  },
  {
    page: "collection_boudoir",
    name: "layout.ss_boudoir_name",
    to: "/collection/ss-boudoir",
  },
  {
    page: "collection_hime",
    name: "layout.fw_hime_name",
          ...
          <div className="flex lg:flex-1">
            <TranslateLink
              ...
              className={`-m-1.5 p-1.5 ${
                currentPage === "index" ? "text-amber-600" : "text-gray-900"
          ...
          <Popover.Group className="hidden lg:flex lg:gap-x-10">
            <Popover className="relative">
              <Popover.Button
                className={`inline-flex items-center gap-x-1 text-sm font-semibold leading-6 ${
                  currentPage.startsWith("collection_")
                    ? "text-amber-600"
                    : "text-gray-900"
                } hover:text-amber-500 p-2`}
              >
                <span>
            ...
            <TranslateLink
              ...
              className={`text-sm font-semibold leading-6 ${
                currentPage === "about" ? "text-amber-600" : "text-gray-900"
              } hover:text-amber-500 p-2`}
            >
            ...
            <TranslateLink
              to="/contact"
              className={`text-sm font-semibold leading-6 ${
                currentPage === "contact" ? "text-amber-600" : "text-gray-900"
              } hover:text-amber-500 p-2`}
            >
            ...
            {language === "pt" ? (
              <LanguageSelector
                className="text-sm font-semibold leading-6 text-gray-900 hover:text-amber-500 p-2"
                language="en"
              >
                EN 🇬🇧
              </LanguageSelector>

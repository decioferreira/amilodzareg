...
export default function SsBoudoirPage() {
  ...
  return (
    <Layout currentPage="collection_boudoir">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="columns-2 md:columns-3 gap-4">
          <StaticImage
            ...
            src="../../images/ss-boudoir/01.jpg"
            alt={t`collections.ss_boudoir`}
          />
          <StaticImage
            className="h-auto w-full rounded-lg mb-4"
            src="../../images/ss-boudoir/02.jpg"
            alt={t`collections.ss_boudoir`}
          />
          <StaticImage
            className="h-auto max-w-full rounded-lg mb-4"
            src="../../images/ss-boudoir/03.jpg"
            alt={t`collections.ss_boudoir`}
          />
          <StaticImage
            className="h-auto max-w-full rounded-lg mb-4"
            src="../../images/ss-boudoir/04.jpg"
            alt={t`collections.ss_boudoir`}
          />
          <StaticImage
            className="h-auto max-w-full rounded-lg mb-4"
            src="../../images/ss-boudoir/05.jpg"
            alt={t`collections.ss_boudoir`}
          />
          <StaticImage
            className="h-auto max-w-full rounded-lg mb-4"
            src="../../images/ss-boudoir/06.jpg"
            alt={t`collections.ss_boudoir`}
          />
          <StaticImage
            className="h-auto max-w-full rounded-lg mb-4"
            src="../../images/ss-boudoir/07.jpg"
            alt={t`collections.ss_boudoir`}
          />
          <StaticImage
            className="h-auto w-full rounded-lg mb-4"
            src="../../images/ss-boudoir/08.jpg"
            alt={t`collections.ss_boudoir`}
          />
          <StaticImage
            className="h-auto w-full rounded-lg mb-4"
            src="../../images/ss-boudoir/09.jpg"
            alt={t`collections.ss_boudoir`}
          />
          <StaticImage
            className="h-auto w-full rounded-lg mb-4"
  ...
  return (
    <title>
      {pageContext.language === "pt"
        ? "Coleção Boudoir Primavera/Verão | Amilod Zareg"
        : "Spring/Summer Boudoir Collection | Amilod Zareg"}
    </title>
  );
};

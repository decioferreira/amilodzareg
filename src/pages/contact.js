          ...
          <div className="mx-auto max-w-2xl space-y-16 divide-y divide-gray-100 lg:mx-0 lg:max-w-none">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
              <div>
                ...
                <a
                  ...
                  href="https://goo.gl/maps/ParyhgWRiumbwAtB8"
                >
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 pt-16 lg:grid-cols-3">
              <div>
                ...
                <p className="mt-4 leading-7 text-gray-600">
                  <Translate id="contact.send_us_a_message_01" />{" "}
                  <a
                    className="font-semibold text-amber-600 hover:text-amber-500"
                    href="https://www.facebook.com/amilodzareg"
                  >
                  ...
                  <Translate id="contact.send_us_a_message_or" />{" "}
                  <a
                    className="font-semibold text-amber-600 hover:text-amber-500"
                    href="https://www.instagram.com/amilodzareg"
                  >
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 pt-16 lg:grid-cols-3">
              <div>
                <h2 className="text-3xl font-bold tracking-tight text-gray-900">
                  <Translate id="contact.follow_us_online" />
                </h2>
                <p className="mt-4 leading-7 text-gray-600">
  ...
  return (
    <title>
      {pageContext.language === "pt"
        ? "Contactos | Amilod Zareg"
        : "Contact Us | Amilod Zareg"}
    </title>
  );
};
